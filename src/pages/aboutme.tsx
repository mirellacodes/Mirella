...
const AboutMe: NextPage = () => {
  return (
    <>
      <Head>
        <title>Mirella's Portfolio | About Me</title>
        <html lang="en" />
      </Head>
      <MainLayout>
        <NavBar />
            ...
            <S.TextWrap>
              ...
              <FadeIn delay={400} transitionDuration={700}>
                <Text className="first-bio">
                  ...
                  excell in Maths in order to pursue a path in tech. I went on
                  to study Criminology and Sociology at the university.
                  Throughout the course, we taught how to conduct a research
                  using SPSS (Social Package for the Social Sciences) which is
                  software that allows you to record, edit and analyse all sorts
                  of data. I fell in love with working with the data and this
                  made me want to pursue a career in Tech. I ended up
                  researching on how to get myself onto this path. I was lucky
                  to have a friend who taught me the basic HTML and CSS which
                  fueled my passion even further. I ended up in dilemma whether
                  to teach myself, enroll in a conversion Master degree at the
              ...
              <FadeIn delay={600} transitionDuration={1800}>
                <Text className="first-bio">
                  ...
                  was lucky to have a friend who taught me the basic HTML and
                  CSS which fuel my passion even further. I ended up in dilemma
                  whether to teach myself, enroll in a conversion Master degree
                  at the University or enroll at a Bootcamp.
                </Text>
              </FadeIn>
              ...
              <FadeIn delay={1800} transitionDuration={2000}>
                <Text className="first-bio">
                  ...
                  methodologies. Each week, I met different people from the
                  course and had the chance to communicate, utilise
                  Pair-Programming and participate weekly Hackathons whenever
                  possible.
                </Text>
              </FadeIn>
            </S.TextWrap>
