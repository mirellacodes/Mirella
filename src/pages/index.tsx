        ...
        <S.Container>
          ...
          <FadeIn delay={800} transitionDuration={1500}>
            <Text className="bio">
              ...
              participated weekly Hackathons, delivered MVP during Project Week
              in an agile team of 4, learnt various tools and technologies such
              as JavaScript, React, Node.js, PostgreSQL, Agile Methodologies,
              Pair Programming and many more. This website is created with
